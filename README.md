...
Le but est simple : **Éclatez tout ce qui bouge** (ou presque) en 60 secondes.

-   **Multiplier Combo** : Touchez des cibles rapidement pour multiplier vos points.
    
-   **Precision Hit** : Chaque clic compte. Ne laissez aucune cible s'échapper !
...
Les cieux sont régis par deux entités aux pouvoirs opposés. Apprenez à les reconnaître !
...
-   **Logic** : Programmation Orientée Objet (POO) en Vanilla JavaScript.
    
-   **VFX** : Système de particules "Pixel-Burst" et retour haptique visuel.
    
-   **Dynamic Difficulty** : 3 Mondes avec ajustement de la vitesse de spawn.
    
-   **Storage** : Sauvegarde locale du Top 15 mondial via le `localStorage`.
...
>>>>>>> 8dc2ff11b24bb90f87b510ea88fb219d1293d2ce
